...
from lib.Curves.CurveVertex import CurveVertexLinearAngle, CurveVertexLinearAngleAngle
...
class DatasetsManagerVertexAngleAngle(DatasetsBaseManager):
    ...
    @property
    def base_name(self):
        return f"{super(DatasetsManagerVertexByAngleLines, self).base_name}_" \
               f"Angle1Limits{self.angle1_limits[0]}pi{self.angle1_limits[1]}pi_" \
